<template>
  <div>
    <!-- <a class="tab_item">
        ...
        <span class="tab_name">{{ TabName }}</span>
    </a> -->
    <button
      class="tab_item"
      v-for="tab in tabs"
...
export default {
  name: "BaseTabs",
    data() {
      return {
      currentTab: 'Готовые',
      tabs: ['Готовые', 'На заказ', 'Планировщик']
    }
  }
}
...
.tab_item .material-symbols-outlined {
    transition: font-weight 0.5s ease, font-variation-settings 0.5s ease, transform 0.5s ease;    
}
