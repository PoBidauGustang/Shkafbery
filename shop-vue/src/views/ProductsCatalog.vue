<template>
  <section class="base_page">
    <h1 class="base_page_title">Каталог товаров</h1>
    <div class="base_page_meta_wrapper">
      <p class="base_page_description">Описание каталога товаров</p>
...
.base_page_img_wrapper {
  grid-column: 7 / span 6;
  overflow: hidden;
  aspect-ratio: 3 / 2;
}

.base_page_img_wrapper img {
  width: 100%;
  height: 100%;
  object-fit: cover;
}
